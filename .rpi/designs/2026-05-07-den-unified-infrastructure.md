...
- A little of the second and third. I've been thinking about this intersection for a long time. I've always struggled in the early exploratory and adoption stages of creating an "outboard brain" because I didn't have an LLM to help me approach the structure when writing reference or permanent notes. I want a "daemon" to help me link my thinking and help me organize the thousands of disparate thoughts written down across a dozen systems over the decades.

See also /home/worldofgeese/Downloads/Technical Writer's Workshop #4 connecting minds with Personal Knowledge Management.txt which is a talk I gave at my employer on the subject

- Today, specifically, it's a new ALIEN The Roleplaying Game campaign I'm starting and I have a few hours to write and fill a prep template. But the idea is to use this sytem for everything from creative projects to my newsletter to collecting and reasoning about philosophy in other words a tool for better thinking

/home/worldofgeese/Downloads/ALIEN_Evolved_Edition_Starter_Set_adventure_booklet_v1_0.pdf

/home/worldofgeese/Downloads/return_of_the_lazy_dungeon_master_markdown.zip
